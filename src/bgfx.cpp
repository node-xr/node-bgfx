...
napi_value create_bgfx(napi_env env)
{
  ...
  export_function(env, exports, "bgfx_vertex_decl_begin", napi_bgfx_vertex_decl_begin);
  export_function(env, exports, "bgfx_vertex_decl_add", napi_bgfx_vertex_decl_add);
  export_function(env, exports, "bgfx_vertex_decl_has", napi_bgfx_vertex_decl_has);
  export_function(env, exports, "bgfx_vertex_decl_skip", napi_bgfx_vertex_decl_skip);
  export_function(env, exports, "bgfx_vertex_decl_end", napi_bgfx_vertex_decl_end);
  export_function(env, exports, "bgfx_vertex_convert", napi_bgfx_vertex_convert);
  export_function(env, exports, "bgfx_topology_convert", napi_bgfx_topology_convert);
  export_function(env, exports, "bgfx_get_renderer_name", napi_bgfx_get_renderer_name);
  export_function(env, exports, "bgfx_shutdown", napi_bgfx_shutdown);
  export_function(env, exports, "bgfx_reset", napi_bgfx_reset);
  export_function(env, exports, "bgfx_frame", napi_bgfx_frame);
  export_function(env, exports, "bgfx_get_renderer_type", napi_bgfx_get_renderer_type);
  export_function(env, exports, "bgfx_set_debug", napi_bgfx_set_debug);
  export_function(env, exports, "bgfx_dbg_text_clear", napi_bgfx_dbg_text_clear);
  export_function(env, exports, "bgfx_dbg_text_printf", napi_bgfx_dbg_text_printf);
  export_function(env, exports, "bgfx_dbg_text_image", napi_bgfx_dbg_text_image);
  export_function(env, exports, "bgfx_create_index_buffer", napi_bgfx_create_index_buffer);
  export_function(env, exports, "bgfx_set_index_buffer_name", napi_bgfx_set_index_buffer_name);
  export_function(env, exports, "bgfx_destroy_index_buffer", napi_bgfx_destroy_index_buffer);
  export_function(env, exports, "bgfx_create_vertex_buffer", napi_bgfx_create_vertex_buffer);
  export_function(env, exports, "bgfx_set_vertex_buffer_name", napi_bgfx_set_vertex_buffer_name);
  export_function(env, exports, "bgfx_destroy_vertex_buffer", napi_bgfx_destroy_vertex_buffer);
  export_function(env, exports, "bgfx_create_dynamic_index_buffer", napi_bgfx_create_dynamic_index_buffer);
  export_function(env, exports, "bgfx_create_dynamic_index_buffer_mem", napi_bgfx_create_dynamic_index_buffer_mem);
  export_function(env, exports, "bgfx_update_dynamic_index_buffer", napi_bgfx_update_dynamic_index_buffer);
  export_function(env, exports, "bgfx_destroy_dynamic_index_buffer", napi_bgfx_destroy_dynamic_index_buffer);
  export_function(env, exports, "bgfx_create_dynamic_vertex_buffer", napi_bgfx_create_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_create_dynamic_vertex_buffer_mem", napi_bgfx_create_dynamic_vertex_buffer_mem);
  export_function(env, exports, "bgfx_update_dynamic_vertex_buffer", napi_bgfx_update_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_destroy_dynamic_vertex_buffer", napi_bgfx_destroy_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_get_avail_transient_index_buffer", napi_bgfx_get_avail_transient_index_buffer);
  export_function(env, exports, "bgfx_get_avail_transient_vertex_buffer", napi_bgfx_get_avail_transient_vertex_buffer);
  export_function(env, exports, "bgfx_get_avail_instance_data_buffer", napi_bgfx_get_avail_instance_data_buffer);
  export_function(env, exports, "bgfx_create_indirect_buffer", napi_bgfx_create_indirect_buffer);
  export_function(env, exports, "bgfx_destroy_indirect_buffer", napi_bgfx_destroy_indirect_buffer);
  export_function(env, exports, "bgfx_create_shader", napi_bgfx_create_shader);
  export_function(env, exports, "bgfx_set_shader_name", napi_bgfx_set_shader_name);
  export_function(env, exports, "bgfx_destroy_shader", napi_bgfx_destroy_shader);
  export_function(env, exports, "bgfx_create_program", napi_bgfx_create_program);
  export_function(env, exports, "bgfx_create_compute_program", napi_bgfx_create_compute_program);
  export_function(env, exports, "bgfx_destroy_program", napi_bgfx_destroy_program);
  export_function(env, exports, "bgfx_is_texture_valid", napi_bgfx_is_texture_valid);
  export_function(env, exports, "bgfx_calc_texture_size", napi_bgfx_calc_texture_size);
  export_function(env, exports, "bgfx_create_texture", napi_bgfx_create_texture);
  export_function(env, exports, "bgfx_create_texture_2d", napi_bgfx_create_texture_2d);
  export_function(env, exports, "bgfx_create_texture_2d_scaled", napi_bgfx_create_texture_2d_scaled);
  export_function(env, exports, "bgfx_create_texture_3d", napi_bgfx_create_texture_3d);
  export_function(env, exports, "bgfx_create_texture_cube", napi_bgfx_create_texture_cube);
  export_function(env, exports, "bgfx_update_texture_2d", napi_bgfx_update_texture_2d);
  export_function(env, exports, "bgfx_update_texture_3d", napi_bgfx_update_texture_3d);
  export_function(env, exports, "bgfx_update_texture_cube", napi_bgfx_update_texture_cube);
  export_function(env, exports, "bgfx_read_texture", napi_bgfx_read_texture);
  export_function(env, exports, "bgfx_set_texture_name", napi_bgfx_set_texture_name);
  export_function(env, exports, "bgfx_destroy_texture", napi_bgfx_destroy_texture);
  export_function(env, exports, "bgfx_create_frame_buffer", napi_bgfx_create_frame_buffer);
  export_function(env, exports, "bgfx_create_frame_buffer_scaled", napi_bgfx_create_frame_buffer_scaled);
  export_function(env, exports, "bgfx_create_frame_buffer_from_nwh", napi_bgfx_create_frame_buffer_from_nwh);
  export_function(env, exports, "bgfx_set_frame_buffer_name", napi_bgfx_set_frame_buffer_name);
  export_function(env, exports, "bgfx_get_texture", napi_bgfx_get_texture);
  export_function(env, exports, "bgfx_destroy_frame_buffer", napi_bgfx_destroy_frame_buffer);
  export_function(env, exports, "bgfx_create_uniform", napi_bgfx_create_uniform);
  export_function(env, exports, "bgfx_destroy_uniform", napi_bgfx_destroy_uniform);
  export_function(env, exports, "bgfx_create_occlusion_query", napi_bgfx_create_occlusion_query);
  export_function(env, exports, "bgfx_destroy_occlusion_query", napi_bgfx_destroy_occlusion_query);
  export_function(env, exports, "bgfx_set_palette_color_rgba8", napi_bgfx_set_palette_color_rgba8);
  export_function(env, exports, "bgfx_set_view_name", napi_bgfx_set_view_name);
  export_function(env, exports, "bgfx_set_view_rect", napi_bgfx_set_view_rect);
  export_function(env, exports, "bgfx_set_view_rect_ratio", napi_bgfx_set_view_rect_ratio);
  export_function(env, exports, "bgfx_set_view_scissor", napi_bgfx_set_view_scissor);
  export_function(env, exports, "bgfx_set_view_clear", napi_bgfx_set_view_clear);
  export_function(env, exports, "bgfx_set_view_clear_mrt", napi_bgfx_set_view_clear_mrt);
  export_function(env, exports, "bgfx_set_view_mode", napi_bgfx_set_view_mode);
  export_function(env, exports, "bgfx_set_view_frame_buffer", napi_bgfx_set_view_frame_buffer);
  export_function(env, exports, "bgfx_set_view_transform", napi_bgfx_set_view_transform);
  export_function(env, exports, "bgfx_encoder_begin", napi_bgfx_encoder_begin);
  export_function(env, exports, "bgfx_encoder_end", napi_bgfx_encoder_end);
  export_function(env, exports, "bgfx_encoder_set_marker", napi_bgfx_encoder_set_marker);
  export_function(env, exports, "bgfx_encoder_set_state", napi_bgfx_encoder_set_state);
  export_function(env, exports, "bgfx_encoder_set_condition", napi_bgfx_encoder_set_condition);
  export_function(env, exports, "bgfx_encoder_set_stencil", napi_bgfx_encoder_set_stencil);
  export_function(env, exports, "bgfx_encoder_set_scissor", napi_bgfx_encoder_set_scissor);
  export_function(env, exports, "bgfx_encoder_set_scissor_cached", napi_bgfx_encoder_set_scissor_cached);
  export_function(env, exports, "bgfx_encoder_set_transform", napi_bgfx_encoder_set_transform);
  export_function(env, exports, "bgfx_encoder_set_transform_cached", napi_bgfx_encoder_set_transform_cached);
  export_function(env, exports, "bgfx_encoder_set_uniform", napi_bgfx_encoder_set_uniform);
  export_function(env, exports, "bgfx_encoder_set_index_buffer", napi_bgfx_encoder_set_index_buffer);
  export_function(env, exports, "bgfx_encoder_set_dynamic_index_buffer", napi_bgfx_encoder_set_dynamic_index_buffer);
  export_function(env, exports, "bgfx_encoder_set_vertex_buffer", napi_bgfx_encoder_set_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_dynamic_vertex_buffer", napi_bgfx_encoder_set_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_vertex_count", napi_bgfx_encoder_set_vertex_count);
  export_function(env, exports, "bgfx_encoder_set_instance_data_from_vertex_buffer", napi_bgfx_encoder_set_instance_data_from_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer", napi_bgfx_encoder_set_instance_data_from_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_instance_count", napi_bgfx_encoder_set_instance_count);
  export_function(env, exports, "bgfx_encoder_set_texture", napi_bgfx_encoder_set_texture);
  export_function(env, exports, "bgfx_encoder_touch", napi_bgfx_encoder_touch);
  export_function(env, exports, "bgfx_encoder_submit", napi_bgfx_encoder_submit);
  export_function(env, exports, "bgfx_encoder_submit_occlusion_query", napi_bgfx_encoder_submit_occlusion_query);
  export_function(env, exports, "bgfx_encoder_submit_indirect", napi_bgfx_encoder_submit_indirect);
  export_function(env, exports, "bgfx_encoder_set_compute_index_buffer", napi_bgfx_encoder_set_compute_index_buffer);
  export_function(env, exports, "bgfx_encoder_set_compute_vertex_buffer", napi_bgfx_encoder_set_compute_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_compute_dynamic_index_buffer", napi_bgfx_encoder_set_compute_dynamic_index_buffer);
  export_function(env, exports, "bgfx_encoder_set_compute_dynamic_vertex_buffer", napi_bgfx_encoder_set_compute_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_encoder_set_compute_indirect_buffer", napi_bgfx_encoder_set_compute_indirect_buffer);
  export_function(env, exports, "bgfx_encoder_set_image", napi_bgfx_encoder_set_image);
  export_function(env, exports, "bgfx_encoder_dispatch", napi_bgfx_encoder_dispatch);
  export_function(env, exports, "bgfx_encoder_dispatch_indirect", napi_bgfx_encoder_dispatch_indirect);
  export_function(env, exports, "bgfx_encoder_discard", napi_bgfx_encoder_discard);
  export_function(env, exports, "bgfx_encoder_blit", napi_bgfx_encoder_blit);
  export_function(env, exports, "bgfx_request_screen_shot", napi_bgfx_request_screen_shot);
  export_function(env, exports, "bgfx_render_frame", napi_bgfx_render_frame);
  export_function(env, exports, "bgfx_set_platform_data", napi_bgfx_set_platform_data);
  export_function(env, exports, "bgfx_set_marker", napi_bgfx_set_marker);
  export_function(env, exports, "bgfx_set_state", napi_bgfx_set_state);
  export_function(env, exports, "bgfx_set_condition", napi_bgfx_set_condition);
  export_function(env, exports, "bgfx_set_stencil", napi_bgfx_set_stencil);
  export_function(env, exports, "bgfx_set_scissor", napi_bgfx_set_scissor);
  export_function(env, exports, "bgfx_set_scissor_cached", napi_bgfx_set_scissor_cached);
  export_function(env, exports, "bgfx_set_transform", napi_bgfx_set_transform);
  export_function(env, exports, "bgfx_set_transform_cached", napi_bgfx_set_transform_cached);
  export_function(env, exports, "bgfx_set_uniform", napi_bgfx_set_uniform);
  export_function(env, exports, "bgfx_set_index_buffer", napi_bgfx_set_index_buffer);
  export_function(env, exports, "bgfx_set_dynamic_index_buffer", napi_bgfx_set_dynamic_index_buffer);
  export_function(env, exports, "bgfx_set_vertex_buffer", napi_bgfx_set_vertex_buffer);
  export_function(env, exports, "bgfx_set_dynamic_vertex_buffer", napi_bgfx_set_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_set_vertex_count", napi_bgfx_set_vertex_count);
  export_function(env, exports, "bgfx_set_instance_data_from_vertex_buffer", napi_bgfx_set_instance_data_from_vertex_buffer);
  export_function(env, exports, "bgfx_set_instance_data_from_dynamic_vertex_buffer", napi_bgfx_set_instance_data_from_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_set_instance_count", napi_bgfx_set_instance_count);
  export_function(env, exports, "bgfx_set_texture", napi_bgfx_set_texture);
  export_function(env, exports, "bgfx_touch", napi_bgfx_touch);
  export_function(env, exports, "bgfx_submit", napi_bgfx_submit);
  export_function(env, exports, "bgfx_submit_occlusion_query", napi_bgfx_submit_occlusion_query);
  export_function(env, exports, "bgfx_submit_indirect", napi_bgfx_submit_indirect);
  export_function(env, exports, "bgfx_set_compute_index_buffer", napi_bgfx_set_compute_index_buffer);
  export_function(env, exports, "bgfx_set_compute_vertex_buffer", napi_bgfx_set_compute_vertex_buffer);
  export_function(env, exports, "bgfx_set_compute_dynamic_index_buffer", napi_bgfx_set_compute_dynamic_index_buffer);
  export_function(env, exports, "bgfx_set_compute_dynamic_vertex_buffer", napi_bgfx_set_compute_dynamic_vertex_buffer);
  export_function(env, exports, "bgfx_set_compute_indirect_buffer", napi_bgfx_set_compute_indirect_buffer);
  export_function(env, exports, "bgfx_set_image", napi_bgfx_set_image);
  export_function(env, exports, "bgfx_dispatch", napi_bgfx_dispatch);
  export_function(env, exports, "bgfx_dispatch_indirect", napi_bgfx_dispatch_indirect);
  export_function(env, exports, "bgfx_discard", napi_bgfx_discard);
  export_function(env, exports, "bgfx_blit", napi_bgfx_blit);
  export_function(env, exports, "bgfx_alloc_vertex_decl", napi_bgfx_alloc_vertex_decl);
  export_function(env, exports, "bgfx_release_vertex_decl", napi_bgfx_release_vertex_decl);
  export_function(env, exports, "bgfx_init_minimal", napi_bgfx_init_minimal);
  return exports;
}
